...
static BBLiveRoomMoreEntranceView* _logos_method$_ungrouped$BBLiveRoomMoreEntranceView$initWithFrame$(_LOGOS_SELF_TYPE_INIT BBLiveRoomMoreEntranceView* __unused self, SEL __unused _cmd, CGRect frame) _LOGOS_RETURN_RETAINED {
    return nil;
}
...
static void _logos_method$_ungrouped$BBLiveVerticalCenterBar$layoutTopPendantContainerView(_LOGOS_SELF_TYPE_NORMAL BBLiveVerticalCenterBar* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    NSLog(@"-[<BBLiveVerticalCenterBar: %p> layoutTopPendantContainerView]: %@", self, (nj_logPrefix));
