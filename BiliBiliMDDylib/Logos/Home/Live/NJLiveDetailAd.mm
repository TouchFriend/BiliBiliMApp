...
static BFCChronosWidgetView* _logos_method$App$BFCChronosWidgetView$initWithServiceKey$uniqueId$(_LOGOS_SELF_TYPE_INIT BFCChronosWidgetView* __unused self, SEL __unused _cmd, id key, id id) _LOGOS_RETURN_RETAINED {
    return _logos_orig$App$BFCChronosWidgetView$initWithServiceKey$uniqueId$(self, _cmd, key, id);
}
